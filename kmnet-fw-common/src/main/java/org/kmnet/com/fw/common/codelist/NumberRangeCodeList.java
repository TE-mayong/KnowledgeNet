...
public class NumberRangeCodeList extends AbstractCodeList implements
     ...
     * </p>
     * @see org.kmnet.com.fw.common.codelist.CodeList#asMap()
     */
    @Override
     ...
     * @param from the start of the range of numbers
     */
     ...
     * @param to end of the range of numbers
     */
     ...
     * @param interval the interval between 2 numbers
     */
     ...
     * @param valueFormat the display format of the value part of the codelist
     */
     ...
     * @see String#format(String, Object...)
     * @param labelFormat the display format of the name part of the codelist
     */
