...
public class DefaultExceptionLevelResolver implements ExceptionLevelResolver {
    ...
    /**
     * Sets exception code resolution object.<br>
     * @param exceptionCodeResolver Exception code resolution object
     */
    ...
    /**
     * Determines the level of exception.<br>
     ...
     * </ul>
     * @see org.kmnet.com.fw.common.exception.ExceptionLevelResolver#resolveExceptionLevel(java.lang.Exception)
     */
