...
public class ReadWriteLockMapWrapper<K, V> implements Map<K, V> {
     ...
     * @param map backing map to be locked
     */
     ...
     * </p>
     * @param <T> The type of the method represented by the instance of implementation of this interface.
     */
     ...
     * @param <T> the return type of the method represented by {@code callback}
