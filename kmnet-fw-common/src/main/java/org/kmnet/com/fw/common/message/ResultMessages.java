...
import static org.kmnet.com.fw.common.message.StandardResultMessageType.*;
...
public class ResultMessages implements Serializable, Iterable<ResultMessage> {
	 ...
	 */
	public static final String DEFAULT_MESSAGES_ATTRIBUTE_NAME = StringUtils.uncapitalize(ResultMessages.class
			.getSimpleName());
