...
public class JdbcSequencer<T> implements Sequencer<T>, InitializingBean {
	 ...
	 * @see org.kmnet.com.fw.common.dao.Sequencer#getNext()
	 */
	@Override
	public T getNext() {
	 ...
	 * @see org.kmnet.com.fw.common.dao.Sequencer#getCurrent()
	 */
	@Override
	public T getCurrent() {
	 ...
	 * @param sequenceClass Type of the class in which the next value of the sequence is to be returned
	 */
	 ...
	 * null
	 * @param dataSource the DataSource information used for accessing the database for fetching the next value of the sequence.
	 */
	 ...
	 * @param jdbcTemplate JdbcTemplate directly
	 */
