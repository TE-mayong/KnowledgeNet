...
public class TransactionTokenContextImpl implements TransactionTokenContext {
     ...
     * @see org.kmnet.com.fw.web.token.transaction.TransactionTokenContext#createToken()
     */
    @Override
    ...
    /**
     * set reserveCommand to {@link org.kmnet.com.fw.web.token.transaction.TransactionTokenContextImpl.ReserveCommand#REMOVE_TOKEN}
     * @see org.kmnet.com.fw.web.token.transaction.TransactionTokenContext#removeToken()
     */
    @Override
